...
const QuestionDetails = () => {
    ...
    const handlePostAnswer = (e, answerLength) => {
        ...
        if(User === null){
            ...
            if(answerBody === ''){
                ...
                dispatch(postAnswer({id, noOfAnswers: answerLength + 1, answerBody: answerBody, userAnswered: User.message.name, userId: User.message._id }))
            }
        }
    ...
    const handleUpVote = () => {
        dispatch(voteQuestion(id, 'upVote', User.message._id))
    }

    const handleDownVote = () => {
        dispatch(voteQuestion(id, 'downVote', User.message._id))
    }
